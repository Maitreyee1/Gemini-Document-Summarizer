...
This is a Document Summarizer App that is built using AI Tools. All documentation, comments, and code are generated by AI using prompt engineering.
Manual intervention was needed mostly for minor edits in the code/READMEs, and setting up the environment for deployment on Streamlit Cloud. 
